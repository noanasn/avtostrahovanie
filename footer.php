...
<footer class="text-center text-lg-start bg-body-tertiary text-muted">
        <!-- Section: Links  -->
        <div class="border-top" style="background-color: rgba(0, 0, 0, 0.05);">
        <section class="">
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i> ул. Краснооктябрьская, 9, Калининград, Калининградская обл., 236039</p>
                        <p>
                            <i class="fas fa-envelope me-3"></i>
                            avto_strah@mail.ru
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +7 (4012) 57-83-79</p>
                        <!-- <p><i class="fas fa-print me-3"></i> +7 (4012) 57-83-79</p> -->
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
