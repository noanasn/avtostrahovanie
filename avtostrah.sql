...
CREATE TABLE `model` (
  ...
  `idMarka` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idMarka_idx` (`idMarka`),
  CONSTRAINT `idMarka` FOREIGN KEY (`idMarka`) REFERENCES `marka` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `model` VALUES (1,'Q7',1),(2,'Touareg',2),(3,'RAV4',3),(4,'CX5',4),(5,'CS55',5),(6,'Q8',1),(7,'M5',6),(8,'RDX',7),(9,'Escalade',8),(10,'Tiggo 8',9),(11,'Traverse',10),(12,'C5 Aircross',11),(13,'Matiz',12),(14,'Challenger',13),(15,'Portofino',14),(16,'Fullback',15),(17,'Explorer',16),(18,'Atlas',17),(19,'GV80',18),(20,'F7x',19),(21,'CR-V',20),(22,'H3',21),(23,'Creta',22),(24,'QX80',23),(25,'XF',24),(26,'Cherokee',25),(27,'Rio',26),(28,'Aventador',27),(29,'Range Rover Evoque',28),(30,'LX',29),(31,'Myway',30),(32,'Levante',31),(33,'62',32),(34,'720S',33),(35,'EQC',34),(36,'Pajero Sport',35),(37,'Ariya',36),(38,'Grandland X',37),(39,'3008',38),(40,'Macan',39),(41,'Arkana',40),(42,'Cullinan',41),(43,'Karoq',42),(44,'Forester',43),(45,'SX4',44),(46,'Model S',45),(47,'XC40',46),(48,'Patriot',47),(49,'Газель-Next',48),(50,'XRAY',49),(51,'Senat',50),(53,'Logan',40),(54,'Polo',2);
...
INSERT INTO `user` VALUES (1,'Иванов','Иван','Иванович','1996-06-08','admin','admin','Администратор',NULL),(2,'Петров','Петр','Петрович','2000-01-02','qwe','qwe','Оператор','qwe123');
...
-- Dump completed on 2023-10-16 20:44:55
