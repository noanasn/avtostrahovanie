  ...
  <div class="container" style="margin-top: 62px;">
    <div class="row justify-content-start mb-4">
      <div class="col-md-12">
        ...
        <ul>
          <li><a href="/auto/auto.php">Авторизоваться на сайте</a></li>
          <li>Заполнить все поля формы</li>
          <li>Нажать на кнопку "Отправить заявку"</li>
        </ul>
        <p>После этого, Ваша заявка будет рассмотрена нашим специалистом в течение трёх рабочих дней.</p>
        <ul>
          <li>Если Ваша заявка будет одобрена, Вы сможете увидеть данные о страховом полисе и дальнейшие инструкции в Вашем личном кабинете.</li>
          <li>Если Ваша заявка будет отклонена, Вы сможете увидеть причину отказа и дальнейшие инструкции в Вашем личном кабинете.</li>
        </ul>
      </div>
    </div>
